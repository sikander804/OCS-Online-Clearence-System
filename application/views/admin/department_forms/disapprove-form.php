     ...
     <form class="form-horizontal user mt-5" action ="<?=site_url('admin/department_forms/save_disapproved_form/'.$form->id);?>" method="post" enctype="multipart/form-data">
