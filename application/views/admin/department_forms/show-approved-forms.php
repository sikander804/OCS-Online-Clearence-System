...
//                                                $dept = GetDepartment($form->dept_id);
                                            ...
                                            <td><a href="<?=base_url('admin/department_forms/disapprove_form/'.$form->id);  ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to disaaprove this form?')">Disapprove</a></td>
