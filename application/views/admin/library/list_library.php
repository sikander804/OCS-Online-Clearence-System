...
<div class="container mb-3">
        <div class="row">
            <div class="col-md-4">
                <a href="<?= site_url('admin/library/show_approved_forms')?>" class="btn btn-success">Show Approved Form</a>
            </div>
            <div class="col-md-4">
                <a href="<?= site_url('admin/library/show_disapproved_forms')?>" class="btn btn-danger">Show Disapproved Form</a>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url();  ?>admin/library/disapprove_form/<?php  echo $form->id;  ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to disapprove this form?')">Disapprove</a></td>
                                        </tr>
                                            <?php 
                                        }
                                        }
