...
//                                                $dept = GetDepartment($form->dept_id);
                                            ...
                                            <!--<td><a href="<?php echo base_url();  ?>admin/provost/approve_form/<?php  echo $form->id;  ?>" class="btn btn-info" onclick="return confirm('Are you sure want to approve this form?')">Approve</a></td>-->
                                            <td><a href="<?php echo base_url();  ?>admin/library/disapprove_form/<?php  echo $form->id;  ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to disaaprove this form?')">Disapprove</a></td>
