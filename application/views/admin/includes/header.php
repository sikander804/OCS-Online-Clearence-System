...
<nav class="navbar navbar-expand-lg navbar-light bg-white topbar mb-4 static-top shadow" style="height: 80px;">
...
<!--                    <form
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item no-arrow mx-1">
                                ...
                                <!-- Counter - Alerts -->
                                <a href="<?=site_url('admin/auth/logout')?>"class="nav-link text-gray-600" data-toggle="modal" data-target="#logoutModal">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Welcome <?=$user_data->full_name?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?=site_url('assets/sb-admin/');?>img/undraw_profile.svg">
                            </a>
