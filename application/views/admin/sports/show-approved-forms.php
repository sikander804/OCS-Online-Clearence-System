...
//                                                $dept = GetDepartment($form->dept_id);
                                            ...
                                            <td><a href="<?php echo base_url();  ?>admin/sports/disapprove_form/<?php  echo $form->id;  ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to disaaprove this form?')">Disapprove</a></td>
