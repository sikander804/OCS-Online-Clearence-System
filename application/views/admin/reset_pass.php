            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                    ...
                    <form class="form-horizontal user" id="" method="post" action="<?=site_url('admin/forgot_password/reset/').$id?>">
                    <div class="form-group form-group-user">
                        <label for="new-password" class="label-material">New Password</label>
                        <input id="" placeholder="new password" type="password" name="new_password" required="" class="form-control form-control-user" autocomplete="off"> 
                    </div>
                    <div class="form-group">
                        <label for="confrim-password" class="label-material">Confirm Password</label>
                        <input id="" placeholder="confirm password" type="password" name="confirm_password" required="" class="form-control form-control-user" autocomplete="off">
                    </div>
