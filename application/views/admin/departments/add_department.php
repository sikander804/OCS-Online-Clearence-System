     ...
     <form class="form-horizontal user mt-5" action ="<?=site_url('admin/departments/save_department');?>" method="post" enctype="multipart/form-data">
      ...
      <div class="">
         ...
         <div class="form-group">
            ...
            <input type="text" name="name" style="" class="form-control form-control-user col-6" required="" placeholder="Department Name" value="">
         </div>
